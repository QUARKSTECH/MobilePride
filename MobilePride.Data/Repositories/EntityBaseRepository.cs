using MobilePride.Data.Infrastructure;
...
namespace MobilePride.Data.Repositories
{
    public class EntityBaseRepository<T> : IEntityBaseRepository<T>
            where T : class, IEntityBase, new()
    {
        private MobilePrideContext _dataContext;

        #region Properties
        protected IDbFactory DbFactory { get; }

        protected MobilePrideContext DbContext => _dataContext ?? (_dataContext = DbFactory.Init());
